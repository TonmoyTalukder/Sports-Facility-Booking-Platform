...
const BookingSchema: Schema<IBooking> = new Schema({
  ...
  user: { type: Schema.Types.ObjectId, ref: 'User', required: true }, // Correct type for ObjectId
  facility: { type: Schema.Types.ObjectId, ref: 'Facility', required: true }, // Correct type for ObjectId
